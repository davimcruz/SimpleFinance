            ...
            <div className="flex items-center space-x-2">
              ...
              <Tooltip.Provider>
                <Tooltip.Root delayDuration={0}>
                  ...
                  <Tooltip.Portal>
                    <Tooltip.Content className="rounded bg-zinc-800 p-2 text-white text-sm">
                      Mostra todos os meses, independentemente de terem ou não
                      saldo alocado.
                      <Tooltip.Arrow className="fill-current text-zinc-800" />
                    </Tooltip.Content>
                  </Tooltip.Portal>
                </Tooltip.Root>
              </Tooltip.Provider>
